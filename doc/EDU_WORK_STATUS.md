...
> 최종 업데이트: 2026-03-12 (coredns 완료 — 전체 19개 프로젝트 완료)
...
| 17 | prometheus | prometheus_EDU | Go | **완료** (기본7 + 심화12 + PoC16) |
| 18 | etcd | etcd_EDU | Go | **완료** (기본7 + 심화12 + PoC16) |
| 19 | coredns | coredns_EDU | Go | **완료** (기본7 + 심화12 + PoC16) |

> 1~7: 사용자 지정 순서, 8~14: 자율 배정, 15~19: 사용자 지정
